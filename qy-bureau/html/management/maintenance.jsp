...
<body>
					...
					<div class="qy-aside-menu">
						...
						<ul>
							...
							<li class='on'>
								...
								<ul class="menu-group">
									<li><label>月</label><a href="listTemplate.htm">电脑管理(刘丽娜)</a>
										<span class="handle">
											<span class="edit">编辑</span>
											<span class="divide">|</span>
											<span class="cancel">删除</span>
	...
	<script>
		(function pageScript () {
			...
			//左侧导航点击编辑，编辑目录名
			$('.qy-aside-menu').off('.edit').on('click','.edit',function(){
				var $this = $(this);
				$this.parent().siblings('a').prop('contenteditable',true);
			});
		})();
	</script>
</body>
